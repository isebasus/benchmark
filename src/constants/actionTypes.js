...
export const STATUS_PAGE_LOADED = 'STATUS_PAGE_LOADED';
export const STATUS_PAGE_UNLOADED = 'STATUS_PAGE_UNLOADED';
export const PING_SERVER = 'PING_SERVER';
export const UPDATE_FIELD_EVENT = 'UPDATE_FIELD_EVENT';
